...
> 🎙️ **v2: Voice-note analysis** — upload a WhatsApp .ogg voice note, get transcript + Trust Score.
...
![HackDevengers 2.0](https://img.shields.io/badge/HackDevengers_2.0-Open_Innovation_%C2%B7_Unstop-8A2BE2)
...
Built in 24 hours for HackDevengers 2.0 — Open Innovation, powered by Unstop.
...
[Evaluation Criteria](#-hackdevengers-20--evaluation-criteria-mapping) · [Sources](#-research-sources)
...
6. **🎙️ v2: Voice-note analysis** — upload a WhatsApp .ogg voice note, get transcript + Trust Score
...
| **🎙️ v2: Voice-note analysis** | Upload a WhatsApp .ogg voice note, get transcript + Trust Score | In-memory multimodal speech-to-text forensics via Gemini `inline_data` |
...
## 🏆 HackDevengers 2.0 — Evaluation Criteria Mapping

| Criterion | Evidence from ScamShield |
|---|---|
| **Innovation & Originality** | • Hybrid 3-layer engine (deterministic rules + live RDAP + structured-JSON LLM)<br>• Hinglish-first lexicon<br>• Family-mode output |
| **Problem-Solving Approach** | • Intervenes at the MESSAGE stage, before payment, where every other tool arrives too late<br>• India-specific patterns (digital arrest, fake internships, task scams) |
| **Technical Implementation** | • 18-rule weighted engine<br>• RDAP live domain checks<br>• Gemini responseSchema<br>• Score fusion with clamp + floor of 3 |
| **Functionality & Execution** | • Deployed live<br>• Calibrated 4-sample corpus<br>• Regression-tested scores (20/13/25/97)<br>• Graceful degradation when AI layer is unavailable |
| **User Experience** | • One-paste flow<br>• Animated gauge<br>• Evidence-quoted flags<br>• Zero login<br>• Mobile-first verified at 375px |
| **Real-World Impact** | • ₹22,000 cr fraud wave<br>• Protects students AND their parents<br>• Official reporting guidance (1930 / cybercrime.gov.in) |
| **Scalability & Future Potential** | • Chrome extension<br>• WhatsApp bot<br>• Open API for job platforms<br>• Regional-language lexicons |
...
Built in 24 hours for HackDevengers 2.0. Powered by Unstop. AI by Google Gemini · Hosted on Vercel.
