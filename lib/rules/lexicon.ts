...
export const RULES: Rule[] = [
  // ── PAYMENT ──────────────────────────────────────────────
  {
    ...
    weight: 25,
    patterns: [
      /(?<!\bno\s)registration\s*fee/i,
      /(?<!\bno\s)processing\s*fee/i,
  ...
  // ── AUTHORITY ────────────────────────────────────────────
  {
    ...
    patterns: [
      ...
      /digital\s*arrest/i,
      /\bFIR\b.{0,30}(filed|registered|lodged)/i,
      /\bwarrant\b/i,
  ...
  },
  {
    ...
    patterns: [
      ...
      /parcel.{0,60}seized/i,
      /\b(drugs|mdma|cocaine|heroin|contraband)\b/i,
